...
const FAQItem = ({ id, question, answer, isOpen, onToggle }) => (
  <div className="bg-black text-white rounded-lg h-full border border-white/10 overflow-hidden shadow-md hover:border-white/30 transition-colors duration-300">
    <button
      onClick={() => onToggle(id)}
...
const FAQ = () => {
  // Store the ID of the currently open item (e.g., "0-1" for category 0, item 1)
  ...
  const faqData = [
    ...
    {
      category: "When a death has occurred",
      items: [
        {
          q: "First Steps - Private Residence",
    ...
    },
    {
      ...
      items: [
        ...
        {
          q: "Multicultural, Themed or Personalised Funeral Services",
          a: "Black Tulip Funerals specialize in various funeral services, such as Chinese, Buddhist, Hindu, Punk/Goth, Indigenous and LGBTIQ+. Each service is completely personalized to the request of the family.",
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          q: "What is the difference between a burial, entombment and cremation?",
          a: "<p>The choice of funeral can be an emotional issue, often reflecting religious and ethnic beliefs.</p><br/><strong>Burial:</strong> In a recognised burial place with new grave (or a reopened, existing grave).<br/><br/><strong>Entombment:</strong> In a mausoleum is the preferred resting place in some cultures. The mausoleum is constructed above ground and allows the coffin to be placed into a crypt which is then sealed.<br/><br/><strong>Cremation:</strong> The cremation procedure can only take place where a crematorium exists. The act of cremation takes place once the coffin is committed and only one coffin is cremated at a time.",
        },
        {
    ...
    {
      category: "Pre-paid Funerals",
      items: [
        {
          q: "What are the benefits of a prepaid funeral?",
          a: "A Prepaid Funeral Plan not only enables you to ease the financial burden on loved ones, but it also allows you to plan your goodbye the way you would like it to be, choosing everything from your choice of coffin, flowers and music. Unlike funeral insurance, a prepaid funeral is a one-off cost and there are no ongoing premiums to worry about",
        },
        {
          q: "How much does a prepaid funeral cost?",
          a: "The cost of a prepaid funeral will vary depending on the type of funeral service that you choose. Our arrangers will discuss with you the different types of funeral services, including burial, cremation and other options. Many people now pre-pay for their funeral earlier in life because the cost is more affordable, the price is protected against inflation and they can become involved in the decisions made on the funeral.",
        },
        {
          q: "Who should I tell about my prepaid plans?",
          a: "Some people may feel comfortable discussing their funeral plans with a spouse, adult children or another member of the family. Others, however, may prefer to make arrangements directly in complete confidence. We would strongly advise that if your immediate family is not informed, a trusted friend, solicitor or executor should be notified when a plan is purchased.",
        },
        {
          q: "How secure are my funds? What if you go out of business?",
          a: "The administration of the funds is handled by a well-respected independent public company and have government security. If we were to go out of business, your funds are held by the trust, and the trust would appoint another suitable funeral director to take care of your prepaid plans.",
        },
        {
  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="section-container">
        ...
        {/* Categories in two columns on md screens */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {faqData.map((category, catIdx) => (
            <div key={catIdx} className="space-y-6">
              {/* Category Heading */}
              <h3 className="text-2xl text-center font-display font-bold text-gray-900 mb-2 pl-2 ">
                {category.category}
              </h3>

              {/* Questions (single column inside each category) */}
