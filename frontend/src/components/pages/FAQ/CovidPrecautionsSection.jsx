...
const AccordionItem = ({ question, answer, isOpen, onToggle }) => (
  <div className="bg-white rounded-lg mb-4 border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
    ...
    <div
      className={`px-5 font-body text-gray-600 leading-relaxed text-sm md:text-base text-justify transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? "max-h-[500px] opacity-100 py-5" : "max-h-0 opacity-0 py-0"
        }`}
    >
