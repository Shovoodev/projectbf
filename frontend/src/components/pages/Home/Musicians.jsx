      ...
      <div className="section-container">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-3/5 bg-black rounded-xl overflow-hidden shadow-xl aspect-video relative group cursor-pointer">
            <img
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuA7Wtz4gL6yRdsiXbqNZzw-ToexXzjRCW2nkBG8IHHXeMaKNa2xDQmpNBgOFO2sv2qgxpBSgvHUWtbTfL9q80KDgA0ahc2I7LJhjP8KXkifNCArqipMidteSV_jbsbrN1wUm56XgnrS0ePGiK9_tJ_4iqU8999hMSxJtPbTEdiqlLPCZdgncgk__XQD36TiTyHxrwL3q3TZKmDrpvoo4mOSVfq7BxyN6pHWFbnq9n1VSwns7RYe9joL8qvxNyrRkHH8uUdZoIBkWt8"
              alt="Musicians playing"
              className="w-full h-full object-cover opacity-80"
            />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-16 h-16 bg-red-600 rounded-lg flex items-center justify-center shadow-lg group-hover:bg-red-700 transition-colors">
                <FaPlay className="text-white text-2xl ml-1" />
              </div>
            </div>
            <div className="absolute top-4 left-4 text-white drop-shadow-md font-medium">
              Ave Maria (Catholic Hymn) - A Peaceful Funeral Song...
            </div>
          </div>
