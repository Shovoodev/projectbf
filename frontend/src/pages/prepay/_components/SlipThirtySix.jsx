    ...
    <div className="form-container-base">
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <section>
          ...
          <div className="mt-3 space-y-1">
            ...
            <div className="space-y-1 pt-1">
              <div className="flex items-center gap-1">
                <span className="pdf-label">Fixed dollar amount:</span>

                <input
                  type="text"
                  readOnly
                  className="pdf-input  font-bold"
                  defaultValue="220"
                />
              </div>

              <div className="text-center font-bold text-[rgb(49,41,166)] py-1 text-sm">
                OR
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <input type="number" className="pdf-input w-48" />
        ...
        <section>
          ...
          <p className="pdf-intro-p text-xs mt-1 mb-1">
          ...
          <div className="space-y-1">
            ...
            <div className="pdf-adviser-row">
              ...
              <input type="text" className="pdf-input flex-1" />
            </div>
          ...
          <p className="pdf-intro-p text-xs mt-1">
